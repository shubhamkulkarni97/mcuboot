...
#define APPLICATION_PRIMARY_START_ADDRESS CONFIG_APPLICATION_PRIMARY_START_ADDRESS
#define APPLICATION_SECONDARY_START_ADDRESS CONFIG_APPLICATION_SECONDARY_START_ADDRESS
#define APPLICATION_SIZE CONFIG_APPLICATION_SIZE
...
{
    MCUBOOT_LOG_INF("%s: ID=%d", __func__, (int)id);
